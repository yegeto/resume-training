...
class EducationAdmin(admin.ModelAdmin):
    list_display = ['id', 'school_name', 'degree', 'department', 'start_date', 'end_date', 'updated_date', 'created_date']
    search_fields = ['school_name', 'degree', 'department']
    list_editable = ['school_name', 'degree', 'department', 'start_date', 'end_date']
